...
function f = finufft4d3(x,y,z,p,c,isign,eps,s,t,u,v,o)

if nargin<12, o.dummy=1; end
valid_setpts(3,4,x,y,z,p,[],s,t,u,v,[]);
o.floatprec=class(x);                      % should be 'double' or 'single'
n_transf = valid_ntr(x,c);
plan = finufft_plan(3,4,isign,n_transf,eps,o);
plan.setpts(x,y,z,p,[],s,t,u,v,[]);
f = plan.execute(c);
