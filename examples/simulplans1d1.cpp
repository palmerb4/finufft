...
*/
{
  ...
  finufft_setpts(planA, MA, &xA[0], NULL, NULL,  NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL);
  finufft_setpts(planB, MB, &xB[0], NULL, NULL,  NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL);
