...
/* Simple example of calling the FINUFFT library from C, using C complex type,
   ...
   Compile with:
   gcc -fopenmp example1d1cf.c -I../include ../lib-static/libfinufft.a -o example1d1cf -lfftw3f -lfftw3f_omp -lm
   -lstdc++ or if you have built a single-core version: gcc example1d1cf.c -I../include ../lib-static/libfinufft.a -o
   example1d1cf -lfftw3f -lm -lstdc++
