    ...
    if (ndims > 3)
      for (BIGINT i = 0; i < M; ++i) {
        if ((opts.pirange ? (abs(kp[i]) > 3.0 * PI) : (kp[i] < -N4 || kp[i] > 2 * N4)) || !isfinite(kp[i])) {
          fprintf(stderr, "%s NU pt not in valid range (central three periods): kp[%lld]=%.16g, N4=%lld (pirange=%d)\n",
...
#pragma omp parallel for num_threads(nthr) schedule(dynamic, 1) // each is big
    for (int isub = 0; isub < nb; isub++) {                     // Main loop through the subproblems
      ...
      get_subgrid(offset1, offset2, offset3, offset4, offset5, size1, size2, size3, size4, size5, M0, kx0, ky0, kz0,
                  kp0, kq0, ns, ndims); // sets offsets and sizes
      if (opts.debug > 1) {             // verbose
        if (ndims == 1)
          ...
          printf("\tsubgrid: off %lld,%lld\t siz %lld,%lld\t #NU %lld\n", (long long)offset1, (long long)offset2,
                 (long long)size1, (long long)size2, (long long)M0);
        else if (ndims == 3)
          ...
          printf("\tsubgrid: off %lld,%lld,%lld,%lld\t siz %lld,%lld,%lld,%lld\t #NU %lld\n", (long long)offset1,
                 (long long)offset2, (long long)offset3, (long long)offset4, (long long)size1, (long long)size2,
                 (long long)size3, (long long)size4, (long long)M0);
        else if (ndims == 5)
          printf("\tsubgrid: off %lld,%lld,%lld,%lld,%lld\t siz %lld,%lld,%lld,%lld,%lld\t #NU %lld\n",
                 (long long)offset1, (long long)offset2, (long long)offset3, (long long)offset4, (long long)offset5,
                 (long long)size1, (long long)size2, (long long)size3, (long long)size4, (long long)size5,
                 (long long)M0);
      }
      ...
      if (!(opts.flags & TF_OMIT_SPREADING)) {
        if (ndims == 1)
          ...
          spread_subproblem_4d(offset1, offset2, offset3, offset4, size1, size2, size3, size4, du0, M0, kx0, ky0, kz0,
                               kp0, dd0, opts);
        else if (ndims == 5)
          spread_subproblem_5d(offset1, offset2, offset3, offset4, offset5, size1, size2, size3, size4, size5, du0, M0,
                               kx0, ky0, kz0, kp0, kq0, dd0, opts);
      }
      ...
      if (!(opts.flags & TF_OMIT_WRITE_TO_GRID)) {
        if (nthr > opts.atomic_threshold) { // see above for debug reporting
          add_wrapped_subgrid_thread_safe(offset1, offset2, offset3, offset4, offset5, size1, size2, size3, size4,
                                          size5, N1, N2, N3, N4, N5, data_uniform,
                                          du0); // R Blackwell's atomic version
        } else {
#pragma omp critical
          add_wrapped_subgrid(offset1, offset2, offset3, offset4, offset5, size1, size2, size3, size4, size5, N1, N2,
                              N3, N4, N5, data_uniform, du0);
        }
      }
      ...
      for (int ibuf = 0; ibuf < bufsize; ibuf++) {
        ...
        if (!(opts.flags & TF_OMIT_SPREADING)) {
          ...
          case 3:
            ...
            break;
          case 4:
            interp_hypercube_4D(target, data_uniform, ker1, ker2, ker3, ker4, i1, i2, i3, i4, N1, N2, N3, N4, ns);
            break;
          case 5:
            interp_hypercube_5D(target, data_uniform, ker1, ker2, ker3, ker4, ker5, i1, i2, i3, i4, i5, N1, N2, N3, N4,
                                N5, ns);
            break;
    ...
    for (int dp = 0; dp < size4; dp++) {      // use ptr lists in each axis
      ...
      for (int dz = 0; dz < size3; dz++) {
        ...
        for (int dy = 0; dy < size2; dy++) {
          ...
          FLT *in = du0 + 2 * size1 * (dy + size2 * (dz + size3 * (dp + size4 * dq))); // ptr to subgrid array (DANGER
