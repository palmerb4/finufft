...
int invokeGuruInterface(int n_dims, int type, int n_transf, BIGINT nj, FLT *xj, FLT *yj, FLT *zj, FLT *pj, FLT *qj,
                        CPX *cj, int iflag, FLT eps, BIGINT *n_modes, BIGINT nk, FLT *s, FLT *t, FLT *u, FLT *v, FLT *w,
...
//  Type-1 1D complex nonuniform FFT. See ../docs/usage.rst
{
  ...
  int n_transf = 1;
  int type = 1;
  int ier = invokeGuruInterface(n_dims, type, n_transf, nj, xj, NULL, NULL, NULL, NULL, cj, iflag, eps, n_modes, 0,
                                NULL, NULL, NULL, NULL, NULL, fk, opts);
  return ier;
}

int FINUFFT1D1MANY(int n_transf, BIGINT nj, FLT *xj, CPX *cj, int iflag, FLT eps, BIGINT ms, CPX *fk, nufft_opts *opts)
...
int FINUFFT1D2MANY(int n_transf, BIGINT nj, FLT *xj, CPX *cj, int iflag, FLT eps, BIGINT ms, CPX *fk, nufft_opts *opts)
...
// Type-3 1D complex nonuniform FFT. See ../docs/usage.rst
{
  ...
  int n_transf = 1;
  int type = 3;
  int ier = invokeGuruInterface(n_dims, type, n_transf, nj, xj, NULL, NULL, NULL, NULL, cj, iflag, eps, NULL, nk, s,
                                NULL, NULL, NULL, NULL, fk, opts);
  return ier;
}

int FINUFFT1D3MANY(int n_transf, BIGINT nj, FLT *xj, CPX *cj, int iflag, FLT eps, BIGINT nk, FLT *s, CPX *fk,
                   nufft_opts *opts)
...
//  Type-1 2D complex nonuniform FFT. See ../docs/usage.rst
{
  ...
  int n_transf = 1;
  int type = 1;
  int ier = invokeGuruInterface(n_dims, type, n_transf, nj, xj, yj, NULL, NULL, NULL, cj, iflag, eps, n_modes, 0, NULL,
                                NULL, NULL, NULL, NULL, fk, opts);
  return ier;
}
...
//  Type-1 2D complex nonuniform FFT, many vectors. See ../docs/usage.rst
{
  ...
  int n_dims = 2;
  int type = 1;
  int ier = invokeGuruInterface(n_dims, type, n_transf, nj, xj, yj, NULL, NULL, NULL, c, iflag, eps, n_modes, 0, NULL,
                                NULL, NULL, NULL, NULL, fk, opts);
  return ier;
}
...
int FINUFFT2D2MANY(int n_transf, BIGINT nj, FLT *xj, FLT *yj, CPX *c, int iflag, FLT eps, BIGINT ms, BIGINT mt, CPX *fk,
                   nufft_opts *opts)
...
int FINUFFT2D3(BIGINT nj, FLT *xj, FLT *yj, CPX *cj, int iflag, FLT eps, BIGINT nk, FLT *s, FLT *t, CPX *fk,
               nufft_opts *opts)
// Type-3 2D complex nonuniform FFT.  See ../docs/usage.rst
{
  ...
  int type = 3;
  int n_transf = 1;
  int ier = invokeGuruInterface(n_dims, type, n_transf, nj, xj, yj, NULL, NULL, NULL, cj, iflag, eps, NULL, nk, s, t,
                                NULL, NULL, NULL, fk, opts);
  return ier;
}

int FINUFFT2D3MANY(int n_transf, BIGINT nj, FLT *xj, FLT *yj, CPX *cj, int iflag, FLT eps, BIGINT nk, FLT *s, FLT *t,
...
//  Type-1 3D complex nonuniform FFT.   See ../docs/usage.rst
{
  ...
  int n_transf = 1;
  int type = 1;
  int ier = invokeGuruInterface(n_dims, type, n_transf, nj, xj, yj, zj, NULL, NULL, cj, iflag, eps, n_modes, 0, NULL,
                                NULL, NULL, NULL, NULL, fk, opts);
  return ier;
}

int FINUFFT3D1MANY(int n_transf, BIGINT nj, FLT *xj, FLT *yj, FLT *zj, CPX *cj, int iflag, FLT eps, BIGINT ms,
...
int FINUFFT3D2MANY(int n_transf, BIGINT nj, FLT *xj, FLT *yj, FLT *zj, CPX *cj, int iflag, FLT eps, BIGINT ms,
                   BIGINT mt, BIGINT mu, CPX *fk, nufft_opts *opts)
...
int FINUFFT3D3(BIGINT nj, FLT *xj, FLT *yj, FLT *zj, CPX *cj, int iflag, FLT eps, BIGINT nk, FLT *s, FLT *t, FLT *u,
               CPX *fk, nufft_opts *opts)
//  Type-3 3D complex nonuniform FFT.   See ../docs/usage.rst
{
  ...
  int n_transf = 1;
  int type = 3;
  int ier = invokeGuruInterface(n_dims, type, n_transf, nj, xj, yj, zj, NULL, NULL, cj, iflag, eps, NULL, nk, s, t, u,
                                NULL, NULL, fk, opts);
  return ier;
}

int FINUFFT3D3MANY(int n_transf, BIGINT nj, FLT *xj, FLT *yj, FLT *zj, CPX *cj, int iflag, FLT eps, BIGINT nk, FLT *s,
...
//  Type-1 4D complex nonuniform FFT.   See ../docs/usage.rst
{
  ...
  int n_transf = 1;
  int type = 1;
  int ier = invokeGuruInterface(n_dims, type, n_transf, nj, xj, yj, zj, pj, NULL, cj, iflag, eps, n_modes, 0, NULL,
                                NULL, NULL, NULL, NULL, fk, opts);
  return ier;
}

int FINUFFT4D1MANY(int n_transf, BIGINT nj, FLT *xj, FLT *yj, FLT *zj, FLT *pj, CPX *cj, int iflag, FLT eps, BIGINT ms,
...
int FINUFFT4D2MANY(int n_transf, BIGINT nj, FLT *xj, FLT *yj, FLT *zj, FLT *pj, CPX *cj, int iflag, FLT eps, BIGINT ms,
                   BIGINT mt, BIGINT mu, BIGINT mv, CPX *fk, nufft_opts *opts)
...
int FINUFFT4D3(BIGINT nj, FLT *xj, FLT *yj, FLT *zj, FLT *pj, CPX *cj, int iflag, FLT eps, BIGINT nk, FLT *s, FLT *t,
...
//  Type-3 4D complex nonuniform FFT.   See ../docs/usage.rst
{
  ...
  int n_transf = 1;
  int type = 3;
  int ier = invokeGuruInterface(n_dims, type, n_transf, nj, xj, yj, zj, pj, NULL, cj, iflag, eps, NULL, nk, s, t, u, v,
                                NULL, fk, opts);
  return ier;
}

int FINUFFT4D3MANY(int n_transf, BIGINT nj, FLT *xj, FLT *yj, FLT *zj, FLT *pj, CPX *cj, int iflag, FLT eps, BIGINT nk,
...
int FINUFFT5D1MANY(int n_transf, BIGINT nj, FLT *xj, FLT *yj, FLT *zj, FLT *pj, FLT *qj, CPX *cj, int iflag, FLT eps,
...
int FINUFFT5D2MANY(int n_transf, BIGINT nj, FLT *xj, FLT *yj, FLT *zj, FLT *pj, FLT *qj, CPX *cj, int iflag, FLT eps,
                   BIGINT ms, BIGINT mt, BIGINT mu, BIGINT mv, BIGINT mw, CPX *fk, nufft_opts *opts)
...
int FINUFFT5D3(BIGINT nj, FLT *xj, FLT *yj, FLT *zj, FLT *pj, FLT *qj, CPX *cj, int iflag, FLT eps, BIGINT nk, FLT *s,
...
//  Type-3 5D complex nonuniform FFT.   See ../docs/usage.rst
{
  ...
  int n_transf = 1;
  int type = 3;
  int ier = invokeGuruInterface(n_dims, type, n_transf, nj, xj, yj, zj, pj, qj, cj, iflag, eps, NULL, nk, s, t, u, v, w,
                                fk, opts);
  return ier;
}

int FINUFFT5D3MANY(int n_transf, BIGINT nj, FLT *xj, FLT *yj, FLT *zj, FLT *pj, FLT *qj, CPX *cj, int iflag, FLT eps,
