...
const char *help[] = {"Tester for FINUFFT in 3d, vectorized, all 3 types, either precision.",
                      "",
                      "Usage: finufft3dmany_test ntrans Nmodes1 Nmodes2 Nmodes3 Nsrc [tol [debug [spread_thread "
...
int main(int argc, char *argv[]) {
  ...
  if (argc > 7)
    sscanf(argv[7], "%d", &opts.debug);
  opts.spread_debug = (opts.debug > 1) ? 1 : 0; // see output from spreader
  if (argc > 8)
    sscanf(argv[8], "%d", &opts.spread_thread);
  if (argc > 9)
    sscanf(argv[9], "%d", &opts.maxbatchsize);
  if (argc > 10)
    sscanf(argv[10], "%d", &opts.spread_sort);
  if (argc > 11) {
    sscanf(argv[11], "%lf", &w);
    opts.upsampfac = (FLT)w;
  }
  if (argc > 12)
    sscanf(argv[12], "%lf", &errfail);
...
#pragma omp for schedule(static, TEST_RANDCHUNK)
  ...
  if (ier > 1) {
    ...
    printf("ntr=%d: %lld NU pts to (%lld,%lld,%lld) modes in %.3g s \t%.3g NU pts/s\n", ntransf, (long long)M,
           (long long)N1, (long long)N2, (long long)N3, ti, ntransf * M / ti);
  ...
  if (ier > 1) {
    ...
    printf("%d of: %lld NU pts to (%lld,%lld,%lld) modes in %.3g s  \t%.3g NU pts/s\n", ntransf, (long long)M,
           (long long)N1, (long long)N2, (long long)N3, t, ntransf * M / t);
...
#pragma omp for schedule(static, TEST_RANDCHUNK)
  ...
  if (ier > 1) {
    ...
    printf("ntr=%d: (%lld,%lld,%lld) modes to %lld NU pts in %.3g s \t%.3g NU pts/s\n", ntransf, (long long)N1,
           (long long)N2, (long long)N3, (long long)M, ti, ntransf * M / ti);
  ...
  if (ier > 1) {
    ...
    printf("%d of: (%lld,%lld,%lld) modes to %lld NU pts in %.3g s \t%.3g NU pts/s\n", ntransf, (long long)N1,
           (long long)N2, (long long)N3, (long long)M, t, ntransf * M / t);
