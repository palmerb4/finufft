...
void dirft4d1(BIGINT nj,FLT* x,FLT *y,FLT *z,FLT *p,CPX* c,int iflag,BIGINT ms, BIGINT mt, BIGINT mu, BIGINT mv, CPX* f);
void dirft4d2(BIGINT nj,FLT* x,FLT *y,FLT *z,FLT *p,CPX* c,int iflag,BIGINT ms, BIGINT mt, BIGINT mu, BIGINT mv, CPX* f);
void dirft4d3(BIGINT nj,FLT* x,FLT *y,FLT *z,FLT *p,CPX* c,int iflag,BIGINT nk, FLT* s, FLT* t, FLT *u, FLT* v, CPX* f);

void dirft5d1(BIGINT nj,FLT* x,FLT *y,FLT *z,FLT *p,FLT *q,CPX* c,int iflag,BIGINT ms, BIGINT mt, BIGINT mu, BIGINT mv, BIGINT mw, CPX* f);
void dirft5d2(BIGINT nj,FLT* x,FLT *y,FLT *z,FLT *p,FLT *q,CPX* c,int iflag,BIGINT ms, BIGINT mt, BIGINT mu, BIGINT mv, BIGINT mw, CPX* f);
void dirft5d3(BIGINT nj,FLT* x,FLT *y,FLT *z,FLT *p,FLT *q,CPX* c,int iflag,BIGINT nk, FLT* s, FLT* t, FLT *u, FLT* v, FLT *w, CPX* f);
#endif
