...
************************************************************************
      ...
      complex*8 cj(nj),fk(-ms/2:(ms-1)/2,-mt/2:(mt-1)/2,-mu/2:(mu-1)/2,-mv/2:(mv-1)/2,-mw/2:(mw-1)/2)
c ----------------------------------------------------------------------
...
************************************************************************
      ...
      complex*8 zf, cm1, cm2, z1n(-ms/2:(ms-1)/2), z2n(-mt/2:(mt-1)/2), z3n(-mu/2:(mu-1)/2), z4n(-mv/2:(mv-1)/2)
c
    do k5 = -mw/2, (mw-1)/2
        do k4 = -mv/2, (mv-1)/2
            do k3 = -mu/2, (mu-1)/2
            ...
            do k4 = -mv/2, (mv-1)/2
                ...
                do k3 = -mu/2, (mu-1)/2
                    ...
                    do k2 = -mt/2, (mt-1)/2
                        cm1 = cm2 * z3n(k3)
                        do k1 = -ms/2, (ms-1)/2
                            fk(k1,k2,k3,k4,k5) = fk(k1,k2,k3,k4,k5) + cm1 * z1n(k1)
                        enddo
                    enddo
                enddo
            enddo
...
************************************************************************
      ...
      complex*8 zf, cm1,cm2,cm3,z1n(-ms/2:(ms-1)/2),z2n(-mt/2:(mt-1)/2),z3n(-mu/2:(mu-1)/2),z4n(-mv/2:(mv-1)/2)
c
      do j = 1, nj
c
c     ----------------------------------------------------------
...
c
************************************************************************
      subroutine dirft5d3f(nj,xj,yj,zj,pj,qj,cj, iflag, nk,sk,tk,uk,vk,wk,fk)
      implicit none
      integer nj, iflag, nk
      real*4 xj(nj), yj(nj), zj(nj), pj(nj), qj(nj), sk(nk), tk(nk), uk(nk), vk(nk), wk(nk)
